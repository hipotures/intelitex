...
export function Realtime() {
  ...
  useEffect(() => {
    ...
    async function refresh() {
      ...
      refreshing = true
      const predicate = (q: { queryKey: readonly unknown[]; getObserversCount(): number }) => q.queryKey[0] === scope && q.getObserversCount() > 0 && !String(q.queryKey[1]).includes('/reader/chapters/')
